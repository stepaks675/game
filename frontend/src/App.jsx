        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex">
            ...
            <div className="font-bold text-3xl">LEGENDS</div>
              ...
              <Block img="assets/addidy.jpg" link="https://x.com/nair_advaith"/>
            ...
            <div className="w-[150px] flex flex-col gap-10 items-center justify-start">
              ...
              <Block img="assets/fleece.jpg" link="https://x.com/Fleece654199"/>
              <Block img="assets/godbless.jpg" link="https://x.com/CryptoH0lly"/>
...
const Block = ({ img, link }) => {
  return (
    <a href={link} target="_blank" rel="noopener noreferrer">
      <div className="h-[100px] w-[100px] hover:scale-110 cursor-pointer transition-all duration-300 border-4 border-yellow-300">
